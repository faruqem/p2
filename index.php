    ...
    <body>
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="well">
                        <h4>Your Password: <mark><?php if (isset($suggestedPassword) and $suggestedPassword != "") {echo $suggestedPassword;} else { echo "Click on the Generate Password button. Your password will be displayed here!";} ?></mark></h4><hr>
                        ...
                        <form class="form-horizontal" action="index.php" method="GET">
                            ...
                            <h4>Status Message: <mark><?php if (isset($error) && $error!="" ){echo $error;} else {echo "Click on the Generate Password button for a new random password!";} ?></h4></mark>
                        </form>
                    </div>
                </div>
            </div>
